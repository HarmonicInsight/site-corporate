...
export default function CompanyPage() {
  ...
  const history = [
    ...
    { date: "2025年", event: "Insightシリーズ・サービス公開" },
  ];
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {businessAreas.map((area, index) => {
              ...
              const LinkOrA = area.external ? "a" : Link;
              const extraProps = area.external
              ...
              return (
                ...
                >
                  ...
                  <span className={`inline-flex items-center text-sm ${colors.text} mt-4`}>
                    詳しく見る →
                  </span>
                </LinkOrA>
              );
      ...
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">主な実績</h3>
              <div className="space-y-6">
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-5">
                  <p className="font-semibold text-gray-900 dark:text-white mb-3">建設業DX</p>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-5">
                  <p className="font-semibold text-gray-900 dark:text-white mb-3">業務システム・RPA</p>
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-5">
                  <p className="font-semibold text-gray-900 dark:text-white mb-3">コンテンツ制作</p>
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="space-y-4">
            {history.map((item, index) => (
              <div key={index} className="flex gap-6">
                ...
                <div className="text-gray-900 dark:text-white text-sm">{item.event}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              ["代表", "瀬田 ルリ子"],
              ["所在地", "東京都"],
              ["連絡先", "info@h-insight.jp"],
              ["事業内容", "建設業DX支援 / ソフトウェア開発 / コンテンツ制作"],
            ].map(([label, value]) => (
              <div key={label} className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                <div className="w-32 flex-shrink-0 text-gray-500 dark:text-gray-400 font-medium text-sm">{label}</div>
                <div className="text-gray-900 dark:text-white text-sm">{value}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 px-4 sm:px-6 bg-gray-50 dark:bg-gray-900/50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">経営体制</h2>
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-6">
              <div className="sm:w-44 flex-shrink-0">
                <p className="text-xs text-gray-500 dark:text-gray-400 tracking-wider mb-0.5">代表社員</p>
                <p className="text-base font-semibold text-gray-900 dark:text-white">瀬田 ルリ子</p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 pt-5 border-t border-gray-200 dark:border-gray-700">
              <div className="sm:w-44 flex-shrink-0">
                <p className="text-xs text-gray-500 dark:text-gray-400 tracking-wider mb-0.5">Chief Architect / Strategist</p>
                <p className="text-base font-medium text-gray-900 dark:text-white">Erik Arthur</p>
              </div>
              <div className="flex-grow">
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      <section className="py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">お問い合わせ</h2>
